"""Studio Tools split — v0.17 visual refresh.
...
in studio_tools_tab.py) and adds the v0.17 chrome (TabHeader strip).
...
panes into the v0.17 layout (24/20 padding, 16 spacing).
"""
