...
Lifted out of the legacy IngestTab._ProxyMatchPane and adapted to the v0.17
...
class _ProxyPane(QWidget):
    ...
    def _run_match(self):
        ...
        self.lbl_summary.setText(
            f"{len(matched)} matched · {len(full_only)} full-res orphans " f"· {len(proxy_only)} proxy orphans"
        )
