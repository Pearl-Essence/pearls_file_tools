"""Main window for Pearl Post Suite — sidebar shell.
...
class MainWindow(QMainWindow):
    ...
    def _build_project_strip(self) -> QWidget:
        ...
        btn.setStyleSheet(
            "QPushButton { text-align: left; border: none; padding: 0; }QPushButton:hover { background: transparent; }"
        )
    ...
    def _build_user_footer(self) -> QWidget:
        ...
        user_btn.setStyleSheet(
            "QPushButton { border: none; padding: 0; text-align: left; }QPushButton:hover { background: transparent; }"
        )
        ...
        avatar.setStyleSheet("background:#2A2418; color:#E8B547; border-radius:11px;font-size:10px; font-weight:700;")
        col = QVBoxLayout()
        col.setSpacing(0)
